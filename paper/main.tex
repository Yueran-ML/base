...
\citep{liu2023omnigrok,humayun2024deep,notsawo2024beyond}, and
...
classification networks, and \citet{notsawo2024beyond} document
...
\citep{bricken2023monosemanticity,cunningham2024sparse} are recent
...
We apply a BIC-selected \citep{schwarz1978estimating} 1-breakpoint
...
\citeauthor{nanda2023progress}'s restricted logit loss.
...
on \citeauthor{nanda2023progress}'s separate dataset.
...
\paragraph{E3. Direct comparison with \citet{nanda2023progress} progress measures.}
Recompute the restricted logit loss and excluded loss of
\citeauthor{nanda2023progress} on the same 54 Stage~4 runs used to
