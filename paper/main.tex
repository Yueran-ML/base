...
All runs used the same PyTorch training loop (Python~3.14,
PyTorch~2.x, NumPy~1.26) with identical model and optimiser code, so
the choice of hardware affects only wall-clock time and not model
outputs at fixed seed.
