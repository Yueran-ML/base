...
def make_curves(rows: list[dict], wd_vals: list[float], outdir: Path) -> None:
    ...
    plt.tight_layout()
    out = outdir / "sub_sweep_curves.png"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Stage 4: sub sweep")
    parser.add_argument("--outdir", default="runs/stage4_sub")
    ...
    csv_path = outdir / "results_stage4_sub.csv"
